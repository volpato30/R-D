...
result = []
for i in range(10):
    temp = train_original_model(hidden_neurons=hidden_neurons, layers=layers)
    result.append(temp)
result = np.asarray(result)
with open('../result/full_original_model_result_{}_{}.p'.format(hidden_neurons, layers), 'wb') as f:
