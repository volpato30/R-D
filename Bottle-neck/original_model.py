...
def train_original_model(num_epochs=500, hidden_neurons=1024, learn_rate=0.1):
...
result = []
for i in range(10):
    temp = train_original_model(hidden_neurons=8192)
    result.append(temp)

result = np.asarray(result)

with open('./result/original_model_result.p', 'wb') as f:
